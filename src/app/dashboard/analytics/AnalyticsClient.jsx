        ...
        <Card variant="outlined" sx={{
            ...
            <CardContent sx={{ p: 1.5, "&:last-child": { pb: 1.5 } }}>
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    <Box>
                        <Typography variant="caption" color="text.secondary" fontWeight={600} sx={{ letterSpacing: "0.05em", textTransform: "uppercase", fontSize: "0.6rem" }}>
                            {label}
                        </Typography>
                        <Typography variant="h6" fontWeight={800} sx={{ mt: 0.25, color: color || "#1f2937", fontSize: "1.1rem" }}>
                            Rs. {fmt(value)}
                        </Typography>
                        {sub && (
                    ...
                    <Box sx={{ p: 1, borderRadius: 2, bgcolor: bgColor || "#f3f4f6", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                {trend !== undefined && (
                    <Box sx={{ mt: 0.5, display: "flex", alignItems: "center", gap: 0.5 }}>
                        ...
                        <Typography variant="caption" sx={{ color: trend >= 0 ? "#059669" : "#dc2626", fontWeight: 600, fontSize: "0.65rem" }}>
            ...
            <Card variant="outlined" sx={{ mb: 3, borderRadius: 3, border: "1px solid #e5e7eb" }}>
                ...
                <Box sx={{ p: 2, display: "flex", flexWrap: "wrap", gap: 2, alignItems: "center" }}>
                    ...
                    <Autocomplete options={tailors} getOptionLabel={o => o.name || ""}
                        ...
                        sx={{ width: 300 }}
                        renderInput={params => <TextField {...params} label="Filter by Tailor" size="small" sx={FIELD_SX} />} />
                    <Autocomplete options={cutters} getOptionLabel={o => o.name || ""}
                        value={filterCutter} onChange={(_, v) => setFilterCutter(v)}
                        sx={{ width: 300 }}
                        renderInput={params => <TextField {...params} label="Filter by Cutter" size="small" sx={FIELD_SX} />} />
                            ...
                            <Card variant="outlined" sx={{ borderRadius: 3, border: "1px solid #e5e7eb", height: "100%" }}>
                                <CardContent sx={{ p: 1.5, "&:last-child": { pb: 1.5 } }}>
                                    <Typography variant="caption" color="text.secondary" fontWeight={600}
                                        sx={{ textTransform: "uppercase", fontSize: "0.6rem", letterSpacing: "0.05em" }}>
                                        Profit Margin
                                    </Typography>
                                    <Typography variant="h6" fontWeight={800} sx={{ mt: 0.25, fontSize: "1.1rem", color: profitMargin >= 0 ? "#059669" : "#dc2626" }}>
                                    ...
                                    <LinearProgress variant="determinate" value={Math.min(Math.abs(profitMargin), 100)}
                                        sx={{
                                            ...
                                            "& .MuiLinearProgress-bar": { bgcolor: profitMargin >= 0 ? "#059669" : "#dc2626", borderRadius: 3 }
                                        }} />
                                </CardContent>
                            </Card>
                        </Grid>
